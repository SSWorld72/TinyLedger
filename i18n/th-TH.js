export default {
    ...
    ui: {
        ...
        settings: {
            dangerZone: {
                title: 'โซนอันตราย',
                desc: 'ล้างข้อมูลบันทึกทั้งหมด กฎคงที่ และการตั้งค่าหมวดหมู่ในเครื่อง หากคุณต้องการเริ่มต้นใหม่ หรือล้างข้อมูลที่ผิดปกติ คุณสามารถคลิกปุ่มด้านล่าง (การกระทำนี้ไม่สามารถยกเลิกได้)',
                button: 'บังคับล้างข้อมูลทั้งหมดในเครื่อง',
                confirmTitle: 'คุณแน่ใจหรือไม่ว่าต้องการล้าง?',
                confirmMsg: 'ซึ่งจะเป็นการลบข้อมูลท้องถิ่นทั้งหมดในโทรศัพท์/คอมพิวเตอร์ของคุณอย่างสมบูรณ์\nการกระทำนี้ไม่สามารถยกเลิกได้ โปรดตรวจสอบให้แน่ใจว่าคุณได้สำรองข้อมูลไว้แล้ว!',
                doubleConfirmTitle: 'การยืนยันครั้งสุดท้าย',
                doubleConfirmMsg: 'คุณแน่ใจหรือไม่ว่าต้องการล้าง?\nการกระทำนี้จะทำลายฐานข้อมูลท้องถิ่นอย่างถาวร',
                btnConfirm: 'ฉันต้องการล้างข้อมูล',
                btnCancel: 'ยกเลิก',
                btnDoubleConfirm: 'ยืนยันเพื่อทำลายข้อมูล',
                btnDoubleCancel: 'ขอคิดดูอีกครั้ง',
                busyTitle: 'กำลังล้างข้อมูล',
                busyDetail: 'กำลังลบ...',
                success: '✅ ล้างข้อมูลทั้งหมดในเครื่องเรียบร้อยแล้ว! ระบบจะโหลดซ้ำโดยอัตโนมัติ',
                error: 'เกิดข้อผิดพลาดในการล้างข้อมูล: {error}'
            },
            systemLogs: {
