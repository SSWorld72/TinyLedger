 ...
 * mountDangerZone('btn-danger-clear', 'TinyLedgerDB');
 *//**
...
export class DangerZoneModule {
    ...
    render() {
        // 使用 Tailwind 兼容的內聯樣式與類別，確保在沒有 Tailwind 的專案(如 TinyLedger) 也能正常顯示
