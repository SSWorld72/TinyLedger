            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-sm w-full overflow-hidden transform transition-all scale-100">
                <div class="p-6">
                    <div class="flex flex-col items-center text-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-slate-800 tracking-tight">${config.title}</h3>
                            <p class="text-sm text-slate-500 mt-2 leading-relaxed">${messageHtml}</p>
                        </div>
                    </div>
                </div>
                
                <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex gap-3">
                    <button id="btn-generic-confirm-cancel" class="flex-1 px-4 py-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 rounded-lg text-sm font-semibold transition-all shadow-xs focus:outline-none focus:ring-2 focus:ring-slate-200">
